...
const MyJobs = () => {
    ...
    useEffect(() =>{
        setIsLoading(true);
        fetch(`http://localhost:3000/myJobs/swethajollu2002@gmail.com`)
        .then(res=>res.json())
        .then(data=>{
            setJobs(data);
            setIsLoading(false);
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      <div className="my-jobs-container">
        <h2 className="text-center p-4 mt-10">
          <b>ALL MY JOBS</b>
        </h2>
        <div className="search-box p-2 text-center mb-2">
          ...
          />
          <button
            className="bg-blue text-white font-bold px-8 py-2 rounded-sm mb-4"
