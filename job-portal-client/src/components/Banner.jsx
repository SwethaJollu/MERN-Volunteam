...
const Banner = ({ query, handleInputChange }) => {
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      <h1 className="text-5xl font-bold text-primary mb-3 " id="ban">
        Find Your<span className="text-blue"> Dream Job</span> Today!!!
      </h1>
      <p className="text-lg text-black/70 mb-8 ">
        <b>
          Unlock a world of boundless IT sector opportunities, just waiting for
          you
        </b>
      </p>
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          ...
          <button type="submit" className="bg-blue py-2 px-8 text-white md:rounded-s-none rounded"><b>Search</b>
